...
git clone https://github.com/zamasu0/android_device_oneplus_sdm845-common_4.19_los --depth=1 -b cosmic_sdm845 device/oneplus/sdm845-common
git clone https://github.com/zamasu0/Dynamic_kernel_4.19_oneplus_sdm845 --depth=1 kernel/oneplus/sdm845
