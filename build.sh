...
git clone https://github.com/zamasu0/android_device_oneplus_sdm845-common_4.19_los --depth=1 -b DYC device/oneplus/sdm845-common
...
git clone https://bitbucket.org/evo-x/vendor_gms.git --depth=1 vendor/gms
